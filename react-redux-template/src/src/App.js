...
import ContextStore from 'src/store/context';
import Facebook from 'src/page/Facebook';
import FacebookRedux from 'src/page/FacebookRedux';
  ...
  return (
    <StyleDiv>
      ...
      <ul>
        ...
        <li>
          <Link to="/FacebookRedux">FacebookRedux</Link>
        </li>
        <li>
          <Link to="/b">b</Link>
        </li>
      ...
      <Switch>
        ...
        <Route exact path="/FacebookRedux" component={FacebookRedux} />
